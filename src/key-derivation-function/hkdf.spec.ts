...
import { type KeyDerivationFunction } from "./key-derivation-function.interface";
import { HkdfService } from "./hkdf.service";
import { type KeyDerivationParameters } from "./key-derivation-parameters.interface";

describe("HKDF Tests", () => {
  let instance: KeyDerivationFunction;

  beforeEach(() => {
    instance = new HkdfService();
  });
